...
<body>
    ...
    <div id="formDiv">
        <form action="#" onsubmit="submitForm(this);return false">
            ...
            <input type="radio" name="reason" id="didntlikelook" value="didntlikelook" onchange="reasonChange()"><label for="didntlikelook">I didn't like how it looked</label><br>
